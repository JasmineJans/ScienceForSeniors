//
//  DiscoverScene2ViewController.swift
//  ScienceForSeniors
//
//  View Controller for presenting the first experience Discover path AR for the second discovery.
...
//  Credit: https://www.youtube.com/watch?v=WEOncb9hXYE
//
//  Created by Jasmine Jans on 4/12/20.
...
class DiscoverScene2ViewController: UIViewController, ARSCNViewDelegate{
    ...
    */
    func addARVideo(){
        let fileURL = URL(fileURLWithPath: Bundle.main.path(forResource: "GrayHairVideo2", ofType: "mp4")!)
    ...
    */
    override func viewWillAppear(_ animated: Bool) {
        ...
        guard let arImages = ARReferenceImage.referenceImages(inGroupNamed: "AR Resources - Grandpa", bundle: nil) else { return }
